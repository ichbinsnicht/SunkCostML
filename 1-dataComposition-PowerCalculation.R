...
dataFrame = dataFrame[,c("forced1","choice1","choice2")]
...
# Bootstrap
rows = 1:nrow(cleanFrame)
cleanFrame = cleanFrame[sample(rows,100,replace=TRUE),]
cleanFrame$choice2 = cleanFrame$choice2 + rnorm(nrow(cleanFrame),0,0.1)
